...
| **Testing** | No tests | 156 unit tests (Vitest) + E2E tests (Playwright) |
...
| **Session Replay** | None | Sentry Session Replay (100% on error, 10% baseline) |
...
| **Tested** | No (0 tests) | Yes (156 tests, 80%+ coverage, CI pipeline) |
