      ...
      <div className="relative w-full max-w-md">
        ...
        {emailSent ? (
          <div className="text-center">
            ...
            <p className="text-hex-muted leading-relaxed mb-2">We sent a confirmation link to</p>
          ...
          <>
            ...
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-sm text-hex-muted">Join hexwave as an artist or curator</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {form.role === 'curator' && (
                  <Alert>
                    <AlertDescription>
                      Curator accounts require verification of{' '}
                      {CURATOR_MIN_LISTENERS.toLocaleString()}+ listeners. You'll start as an artist
                      and can apply for curator status once verified.
                    </AlertDescription>
                  </Alert>
                )}
