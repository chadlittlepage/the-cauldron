...
VALUES
  ...
  ('aaaaaaaa-1000-4000-a000-000000000001', 'aaaaaaaa-0001-4000-a000-000000000001', 'Sailor Song', 'https://open.spotify.com/track/3T4tUhGYeRNVUGevb0wThu', 'spotify', 'Indie Pop', 'A dreamy ode to the pull of the open water and the people we leave behind.', 'accepted', 'demo_pi_001', now() - interval '85 days', now() - interval '85 days', now()),
