...
-- ============================================================================
-- Run in Supabase SQL Editor (requires superuser for auth.users access)
...
-- ──────────────────────────────────────────────
-- 1. Disable auto-profile trigger
-- ──────────────────────────────────────────────
...
-- ──────────────────────────────────────────────
-- 3. Insert 50 profiles
-- ──────────────────────────────────────────────

INSERT INTO public.profiles (id, email, display_name, role, avatar_url, bio, listener_count, created_at, updated_at)
VALUES
  -- 35 Artists
  ('aaaaaaaa-0001-4000-a000-000000000001', 'demo-artist-01@hexwave.demo', 'Luna Waves', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=LunaWaves', 'Dream pop artist blending ambient textures with celestial melodies.', 320, now() - interval '88 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000002', 'demo-artist-02@hexwave.demo', 'Neon Drifter', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=NeonDrifter', 'Synthwave producer from the neon-lit streets of the future.', 180, now() - interval '86 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000003', 'demo-artist-03@hexwave.demo', 'Echo Veil', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=EchoVeil', 'Layering reverb-soaked guitars over whispered confessions.', 95, now() - interval '84 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000004', 'demo-artist-04@hexwave.demo', 'Moss Garden', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=MossGarden', 'Folk-inspired songwriter exploring quiet, overgrown places.', 410, now() - interval '82 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000005', 'demo-artist-05@hexwave.demo', 'Velvet Haze', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=VelvetHaze', 'Psych-soul artist painting in rich, warm frequencies.', 275, now() - interval '80 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000006', 'demo-artist-06@hexwave.demo', 'Circuit Bloom', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=CircuitBloom', 'Electronic producer growing organic sounds from digital seeds.', 150, now() - interval '78 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000007', 'demo-artist-07@hexwave.demo', 'Pale Honey', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=PaleHoney', 'Indie rock duo with a taste for bittersweet harmonies.', 500, now() - interval '76 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000008', 'demo-artist-08@hexwave.demo', 'Tidal Murmur', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=TidalMurmur', 'Coastal ambient project recording the language of the sea.', 60, now() - interval '74 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000009', 'demo-artist-09@hexwave.demo', 'Rust & Ribbon', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=RustRibbon', 'Americana singer-songwriter with stories of open roads.', 340, now() - interval '72 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000010', 'demo-artist-10@hexwave.demo', 'Glass Fauna', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=GlassFauna', 'Art pop creator sculpting fragile, translucent soundscapes.', 215, now() - interval '70 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000011', 'demo-artist-11@hexwave.demo', 'Phantom Choir', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=PhantomChoir', 'Spectral vocal arrangements from a one-person choir.', 130, now() - interval '68 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000012', 'demo-artist-12@hexwave.demo', 'Solstice Kid', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=SolsticeKid', 'Bedroom pop made during the longest days of the year.', 85, now() - interval '66 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000013', 'demo-artist-13@hexwave.demo', 'Iron Petal', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=IronPetal', 'Heavy riffs wrapped in delicate melodic petals.', 390, now() - interval '64 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000014', 'demo-artist-14@hexwave.demo', 'Soft Vandal', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=SoftVandal', 'Lo-fi hip-hop with spraypaint-can percussion.', 200, now() - interval '62 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000015', 'demo-artist-15@hexwave.demo', 'Dawnbreak', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Dawnbreak', 'Uplifting indie folk for early morning drives.', 445, now() - interval '60 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000016', 'demo-artist-16@hexwave.demo', 'Copper Thread', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=CopperThread', 'Weaving analog warmth through every mix.', 110, now() - interval '58 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000017', 'demo-artist-17@hexwave.demo', 'Violet Wreck', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=VioletWreck', 'Shoegaze meets noise pop in a purple haze.', 265, now() - interval '56 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000018', 'demo-artist-18@hexwave.demo', 'River Clerk', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=RiverClerk', 'Jazz-inflected R&B from a bedroom studio by the river.', 175, now() - interval '54 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000019', 'demo-artist-19@hexwave.demo', 'Sage Phantom', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=SagePhantom', 'Minimalist electronic artist channeling desert silence.', 50, now() - interval '52 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000020', 'demo-artist-20@hexwave.demo', 'Halo Static', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=HaloStatic', 'Post-punk revivalist with a love for angular guitars.', 310, now() - interval '50 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000021', 'demo-artist-21@hexwave.demo', 'Fern & Flicker', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=FernFlicker', 'Acoustic duo finding magic in candlelit sessions.', 420, now() - interval '48 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000022', 'demo-artist-22@hexwave.demo', 'Midnight Cartographer', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=MidnightCartographer', 'Mapping uncharted sonic territories after dark.', 75, now() - interval '46 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000023', 'demo-artist-23@hexwave.demo', 'Pollen Drift', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=PollenDrift', 'Dreamy indie pop that floats on a spring breeze.', 290, now() - interval '44 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000024', 'demo-artist-24@hexwave.demo', 'Chrome Pastoral', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=ChromePastoral', 'Where futuristic synths meet rural tranquility.', 155, now() - interval '42 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000025', 'demo-artist-25@hexwave.demo', 'Opal Engine', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=OpalEngine', 'Iridescent beats powered by analog machines.', 365, now() - interval '40 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000026', 'demo-artist-26@hexwave.demo', 'Wren Silence', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=WrenSilence', 'Finding the notes between the notes.', 40, now() - interval '38 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000027', 'demo-artist-27@hexwave.demo', 'Gilt Frequency', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=GiltFrequency', 'Gold-plated funk with electronic undertones.', 480, now() - interval '36 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000028', 'demo-artist-28@hexwave.demo', 'Spectral Orchard', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=SpectralOrchard', 'Harvesting sounds from the spaces between genres.', 120, now() - interval '34 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000029', 'demo-artist-29@hexwave.demo', 'Tender Voltage', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=TenderVoltage', 'Electrifying softness, where power meets vulnerability.', 230, now() - interval '32 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000030', 'demo-artist-30@hexwave.demo', 'Amber Flux', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=AmberFlux', 'Warm analog waves caught in constant transformation.', 190, now() - interval '30 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000031', 'demo-artist-31@hexwave.demo', 'Hollow Pine', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=HollowPine', 'Woodland folk songs echoing through empty forests.', 350, now() - interval '28 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000032', 'demo-artist-32@hexwave.demo', 'Noma Tides', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=NomaTides', 'Nomadic beats flowing with oceanic rhythms.', 145, now() - interval '26 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000033', 'demo-artist-33@hexwave.demo', 'Sable Moth', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=SableMoth', 'Dark, fluttering electronica drawn to the light.', 255, now() - interval '24 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000034', 'demo-artist-34@hexwave.demo', 'Quarry Echo', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=QuarryEcho', 'Cavernous post-rock reverberating through stone.', 100, now() - interval '22 days', now()),
  ('aaaaaaaa-0001-4000-a000-000000000035', 'demo-artist-35@hexwave.demo', 'Thistle Crown', 'artist', 'https://api.dicebear.com/7.x/avataaars/svg?seed=ThistleCrown', 'Regal indie folk with thorns of punk energy.', 470, now() - interval '20 days', now()),
  -- 12 Curators
  ('aaaaaaaa-0002-4000-a000-000000000001', 'demo-curator-01@hexwave.demo', 'The Sound Sage', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=SoundSage', 'Veteran music journalist with an ear for the extraordinary.', 42000, now() - interval '90 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000002', 'demo-curator-02@hexwave.demo', 'Vinyl Verdict', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=VinylVerdict', 'Former record store owner who has heard everything.', 28000, now() - interval '89 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000003', 'demo-curator-03@hexwave.demo', 'Frequency Maven', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=FrequencyMaven', 'Electronic music specialist and festival curator.', 35000, now() - interval '87 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000004', 'demo-curator-04@hexwave.demo', 'The Wax Critic', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=WaxCritic', 'Sharp takes, honest reviews, no fluff.', 18500, now() - interval '85 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000005', 'demo-curator-05@hexwave.demo', 'Groove Architect', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=GrooveArchitect', 'Building playlists that move bodies and minds.', 50000, now() - interval '83 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000006', 'demo-curator-06@hexwave.demo', 'Sonic Compass', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=SonicCompass', 'Pointing listeners toward hidden musical gems.', 22000, now() - interval '81 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000007', 'demo-curator-07@hexwave.demo', 'Decibel Scout', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=DecibelScout', 'Scouring the underground for tomorrow''s hits.', 15000, now() - interval '79 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000008', 'demo-curator-08@hexwave.demo', 'Harmonic Judge', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=HarmonicJudge', 'Classical training meets modern indie sensibility.', 31000, now() - interval '77 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000009', 'demo-curator-09@hexwave.demo', 'Bass Oracle', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=BassOracle', 'Low-end specialist who feels music in the bones.', 12000, now() - interval '75 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000010', 'demo-curator-10@hexwave.demo', 'Treble Alchemist', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=TrebleAlchemist', 'Turning raw demos into golden recommendations.', 26000, now() - interval '73 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000011', 'demo-curator-11@hexwave.demo', 'Pulse Keeper', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=PulseKeeper', 'Has a sixth sense for rhythm and momentum.', 8500, now() - interval '71 days', now()),
  ('aaaaaaaa-0002-4000-a000-000000000012', 'demo-curator-12@hexwave.demo', 'Tone Shepherd', 'curator', 'https://api.dicebear.com/7.x/avataaars/svg?seed=ToneShepherd', 'Guiding new artists through the landscape of sound.', 1200, now() - interval '69 days', now()),
  -- 3 Admins
  ('aaaaaaaa-0003-4000-a000-000000000001', 'demo-admin-01@hexwave.demo', 'HexAdmin Prime', 'admin', 'https://api.dicebear.com/7.x/avataaars/svg?seed=HexAdminPrime', 'Platform founder and chief hexagonal officer.', 0, now() - interval '90 days', now()),
  ('aaaaaaaa-0003-4000-a000-000000000002', 'demo-admin-02@hexwave.demo', 'HexOps Manager', 'admin', 'https://api.dicebear.com/7.x/avataaars/svg?seed=HexOpsManager', 'Keeping the gears turning behind the scenes.', 0, now() - interval '90 days', now()),
  ('aaaaaaaa-0003-4000-a000-000000000003', 'demo-admin-03@hexwave.demo', 'HexMod Lead', 'admin', 'https://api.dicebear.com/7.x/avataaars/svg?seed=HexModLead', 'Community moderator and quality gatekeeper.', 0, now() - interval '90 days', now());
...
-- ──────────────────────────────────────────────
-- 10. Re-enable the auto-profile trigger
-- ──────────────────────────────────────────────
